...
async function info(slug) {
    ...
    try{
        res = await axios.get(`https://saikomangaraw.com/manga/${slug}`)
        ...
        let ch_list = await chaptersList(`https://saikomangaraw.com/manga/${slug}/ajax/chapters/`)
...
async function all(page) {
    ...
    try{
        res = await axios.get(`https://saikomangaraw.com/manga/page/${page}`)
        const body = await res.data;
        const $ = cheerio.load(body)
...
async function chapter(manga,chapter) {
    ...
    try{
        res = await axios.get(`https://saikomangaraw.com/manga/${manga}/${chapter}`)
        const body = await res.data;
        const $ = cheerio.load(body)
